    ...
    public class SoftlandIntegration
    {
        ...
        public int ProcesarDocumento(XmlDocument doc, XmlDocument xmlDocConfiguration, string cadenaConexion)
        {
            ...
            try
            {
                ...
                SqlConnection connection2 = new SqlConnection(cadenaConexion);
                SqlCommand command2 = new SqlCommand("spDetalle", connection2);
                SqlCommand command = new SqlCommand("spCabecera", connection);
